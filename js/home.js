...
function getProductCards( el ) {
  ...
  const aksiiCardImage = document.createElement( "div" );
  ...
  aksiiCardImageLike.innerHTML = "like"
  ...
  aksiiCardButton.className = "aksii-card-btn popular-card-btn novinki-card-btn";
  aksiiCardButton.innerHTML = "В корзину";
